...
export function create3DMenu(scene) {
    ...
    const container = new ThreeMeshUI.Block({
        ...
        fontFamily: 'https://cdn.jsdelivr.net/npm/three-mesh-ui@6.5.4/examples/assets/Roboto-msdf.json',
        fontTexture: 'https://cdn.jsdelivr.net/npm/three-mesh-ui@6.5.4/examples/assets/Roboto-msdf.png',
        fontSize: 0.15,
        padding: 0.2,
        borderRadius: 0.1,
