...
export function create3DMenu(scene) {
    ...
    const container = new ThreeMeshUI.Block({
        ...
        fontFamily: 'https://unpkg.com/three-mesh-ui@7.1.5/examples/assets/Roboto-msdf.json',
        fontTexture: 'https://unpkg.com/three-mesh-ui@7.1.5/examples/assets/Roboto-msdf.png',
        fontSize: 0.15,
        padding: 0.2,
        borderRadius: 0.1,
